    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Fixed Deposite List (Total : {{ $getRecord->total() }})</h1>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Search Share</h3>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/share/list') }}" class="btm btn-success"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Fixed Deposite List</h3>
                                                <div class="col-sm-12" style="text-align:right;">
                                                    <a href="{{ url('admin/fixed/customer') }}" class="btn btn-danger">+ Add
                                                        New Deposite</a>
                                                </div>
                                            </div>
                                            <!-- /.card-header -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($getRecord as $value)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('admin/fixed/details/' . $value->id) }}"
