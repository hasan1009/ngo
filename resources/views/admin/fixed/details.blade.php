            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fa fa-window-restore" aria-hidden="true"></i> <b>Deposite
                                        Transactions</b></h3>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="depositForm" method="post"
                                action="{{ url('admin/fixed/deposit/' . $loan->id) }}">
                                {{ csrf_field() }}
                                <div class="mb-3">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn btn-secondary me-2"
                                    data-bs-dismiss="modal">Cancel</button>
                                <form action="{{ url('admin/fixed/withdraw/' . $loan->id) }}" method="POST"
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ url('admin/fixed/update/' . $loan->id) }}"
