    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Savings List (Total : {{ $getRecord->total() }})</h1>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Search Savings</h3>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/savings/list') }}" class="btm btn-success"
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="col-sm-12" style="text-align:right;">
                                                    <a href="{{ url('admin/savings/customer') }}" class="btn btn-danger">+
                                                        Add
                                                        New Savings</a>
                                                </div>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($getRecord as $value)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('admin/savings/details/' . $value->id) }}"
