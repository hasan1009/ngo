    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Loan List (Total : {{ $getRecord->total() }})</h1>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Search Loan</h3>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select class="form-control" name="meyadType">
                                                        ...
                                                        <option value="Daily"
                                                            {{ Request::get('meyadType') == 'Daily' ? 'selected' : '' }}>
                                                            Daily</option>
                                                        <option value="Weekly"
                                                            {{ Request::get('meyadType') == 'Weekly' ? 'selected' : '' }}>
                                                            Weekly</option>
                                                        <option value="Monthly"
                                                            {{ Request::get('meyadType') == 'Monthly' ? 'selected' : '' }}>
                                                            Monthly</option>
                                                        <option value="Yearly"
                                                            {{ Request::get('meyadType') == 'Yearly' ? 'selected' : '' }}>
                                                            Yearly</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/loan/list') }}" class="btm btn-success"
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="col-sm-12" style="text-align:right;">
                                                    <a href="{{ url('admin/loan/customer') }}" class="btn btn-danger">+ Add
                                                        New Loan</a>
                                                </div>
                                            </div>
                                            <!-- /.card-header -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($getRecord as $value)
                                                            <tr>
                                                                ...
                                                                <td>{{ $value->meyadType }}</td>
                                                                <td>{{ number_format($value->payingAmount, 2) }} BDT</td>
                                                                <td>
                                                                    <a href="{{ url('admin/loan/details/' . $value->id) }}"
