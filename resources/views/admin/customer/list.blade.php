                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/customer/list') }}" class="btm btn-success"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($getRecord as $value)
                                                            <tr>
                                                                ...
                                                                @if (!empty($value->nidPhoto))
                                                                    <td><img src="{{ asset('upload/nid/' . $value->nidPhoto) }}"
                                                                            alt="" style="width:60px; height:60px;">
                                                                    </td>
                                                                @else()
                                                                    <td><img src="{{ asset('upload/nidplace.png') }}"
                                                                            alt="" style="width:60px; height:60px;">
                                                                    </td>
                                                                @endif()
                                                                <td>{{ $value->name }}</td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('admin/customer/details/' . $value->id) }}"
                                                                        class="btn btn-danger">Details</a>
                                                                    <a href="{{ url('admin/sms/sms/' . $value->id) }}"
                                                                        class="btn btn-success">Send SMS</a>
                                                                </td>
