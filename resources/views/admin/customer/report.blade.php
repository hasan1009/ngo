                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <a href="{{ url('admin/customer/report') }}" class="btn btn-success"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <tr>
                                            {{-- <th>#</th> --}}
                                            <th>Date</th>
                                            <th>Daily Collection(BDT)</th>
                                            <th>Weekly Collection(BDT)</th>
                                            <th>Monthly Collection(BDT)</th>
                                            <th>Yearly Collection(BDT)</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($value->loanType == 'Daily')
                                                        @php $dailyTotal += $value->receiveAmount; @endphp
                                                        {{ number_format($value->receiveAmount, 2) }}
                                                    @else
                                                        0
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($value->loanType == 'Weekly')
                                                        @php $weeklyTotal += $value->receiveAmount; @endphp
                                                        {{ number_format($value->receiveAmount, 2) }}
                                                    @else
                                                        0
                                                    @endif
                                                ...
                                                <td>
                                                    @if ($value->loanType == 'Monthly')
                                                        @php $monthlyTotal += $value->receiveAmount; @endphp
                                                        {{ number_format($value->receiveAmount, 2) }}
                                                    @else
                                                        0
                                                    @endif
                                                ...
                                                <td>
                                                    @if ($value->loanType == 'Yearly')
                                                        @php $yearlyTotal += $value->receiveAmount; @endphp
                                                        {{ number_format($value->receiveAmount, 2) }}
                                                    @else
                                                        0
                                                    @endif
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="1">
                                                @php
                                                    $total = $dailyTotal + $weeklyTotal + $monthlyTotal + $yearlyTotal;
                                                @endphp
                                                {{ number_format($total, 2) }} BDT</th>
