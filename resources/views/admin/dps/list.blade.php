    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> DPS List (Total : {{ $getRecord->total() }})</h1>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Search DPS</h3>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/dps/list') }}" class="btm btn-success"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title">Savings List</h3>
                                                <div class="col-sm-12" style="text-align:right;">
                                                    <a href="{{ url('admin/dps/customer') }}" class="btn btn-danger">+
                                                        Add
                                                        New DPS</a>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($getRecord as $value)
                                                            <tr
                                                                onclick="window.location.href='{{ url('admin/dps/details/' . $value->id) }}'">
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('admin/dps/details/' . $value->id) }}"
