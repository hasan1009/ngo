                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title"><b>Search Expense</b></h3>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="{{ url('admin/expense/print') }}" class="btn btn-success"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th colspan="10"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <b>Address:</b> মাঝকাজি বাজার, মেহেন্দিগঞ্জ,
                                                                            বরিশাল
                                                                        </div>
                                                                        <div
                                                                            style="font-size: 18px; font-weight: normal; line-height: 1.1; margin-bottom: 5px;">
                                                                            <b>Mobile:</b> 01772282407, <b>E-Mail:</b>
                                                                            fahadhossain2u@gmail.com
                                                                        </div>
                                                                    </th>
                                                                </tr>
