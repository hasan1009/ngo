            ...
            <div class="container-fluid">
                <div class="row">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-6">
                                            <h3 class="card-title"><i class="fa fa-window-restore" aria-hidden="true"></i>
                                                <b>Insurance Details</b></h3>

                                        </div>
                                        <div class="col-sm-6" style="text-align:right;">
                                            <button class="btn btn-sm btn-primary ml-2" data-bs-toggle="modal"
                                                data-bs-target="#editModal">
                                                <i class="fas fa-edit" style="font-size: 0.8em;"></i> Edit Deposite
                                            </button>
                                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fa fa-window-restore" aria-hidden="true"></i> <b>Insurance
                                        Transactions</b></h3>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="depositForm" method="post"
                                action="{{ url('admin/insurance/deposit/' . $loan->id) }}">
                                {{ csrf_field() }}
                                <div class="mb-3">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn btn-secondary me-2"
                                    data-bs-dismiss="modal">Cancel</button>
                                <form action="{{ url('admin/insurance/withdraw/' . $loan->id) }}" method="POST"
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ url('admin/insurance/update/' . $loan->id) }}"
