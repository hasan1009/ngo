...
<head>
    ...
    <title>{{ !empty($header_title) ? $header_title : 'NGO' }}</title>

    @php
        $getHeaderSettings = App\Models\SettingsModel::getSingle();
    @endphp

    <link href="{{ $getHeaderSettings->getFavicon() }}" rel="icon" type="image/jpg">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        @include('admin.superadmin.header')
        @yield('content')
